...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Category Article</h1>
    <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('b.home')}}"><i class="fas fa-fw fa-tachometer-alt"></i></a></li>
        <li class="breadcrumb-item"><a href="{{route('articlegroups.index')}}">List</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('articlegroups.update',$cate->id) }}">
                @csrf
                @method('PUT')
                ...
                <a name="" id="" class="btn btn-secondary btn-md" href="{{ route('articlegroups.index') }}" role="button">Back to
                    list</a>
